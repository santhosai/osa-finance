    ...
    return (
      <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #3b82f6 0%, #1e40af 100%)' }}>
        <div className="navbar" style={{ background: 'linear-gradient(135deg, #1e293b 0%, #0f172a 100%)' }}>
          ...
          <h2 style={{ margin: 0, color: 'white', fontSize: '20px', fontWeight: 700 }}>Weekly Finance</h2>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '15px' }}>
                ...
                <div>
                  <div style={{ fontSize: '14px', opacity: 0.9 }}>Weekly Payment</div>
                  <div style={{ fontSize: '20px', fontWeight: 700 }}>{formatCurrency(selectedLoan.weekly_amount)}</div>
                </div>
                <div>
          ...
          {weeklyLoans.length === 0 ? (
            <div style={{
              ...
              <div style={{ fontSize: '16px', fontWeight: 600, marginBottom: '8px' }}>
                No Weekly Finance loans yet
              </div>
              <div style={{ fontSize: '14px' }}>
                Click "+ Add Weekly Loan" to create your first one
              </div>
            </div>
          ) : (
                  ...
                  >
                    <div style={{
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <div style={{
                          ...
                          <div>
                            <strong>Weekly:</strong> {formatCurrency(loan.weekly_amount)}
                          </div>
                          <div>
                    ...
                    <div style={{ marginTop: '10px' }}>
                      <div style={{
                        ...
                        <span>Progress: {weeksPaid}/{totalWeeks} weeks</span>
...
export default WeeklyFinanceView;
